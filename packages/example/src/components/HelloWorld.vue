<template>
  <div class="hello" ref="scrollContainer">
    ...
    <g-button 
      @click="handleButtonClick" :value="buttonValue">
      buttonValue1
    </g-button>
    <g-tag></g-tag>
    <!-- <g-slider></g-slider> -->
    ...
    <g-lazy-component @show="handleLazyComponent" class="week-rank">
      <g-button @click="handleButtonClick2" :value="buttonValue"
        >buttonValueLazy</g-button
      >
    </g-lazy-component> -->
    <!-- 折叠面板 -->
...
export default {
  ...
  mounted() {
    ...
    this.themeMedia.addListener(this.listner);
  ...
  beforeDestroy() {
    if (this.themeMedia && typeof this.themeMedia === "function") {
      this.themeMedia.removeListener(this.listner);
    }
  },
  methods: {
    handleButtonClick() {
